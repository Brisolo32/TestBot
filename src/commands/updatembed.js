...
const { colours, version } = require('../config.json');
    ...
    data: new SlashCommandBuilder()
	  ...
	  async execute (interaction) {
        const updatembed = new MessageEmbed()
            ...
            .setFooter({ text: `Brisolo32 | Copyleft 2021-2022 | v${version}`, iconURL: 'https://cdn.discordapp.com/app-icons/922283721791504426/ba24abb016d5986dc74643ad5bbf6b70.png?size=256' })
