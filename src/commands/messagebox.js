...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('messagebox')
        .setDescription('Sends a windows looking message box | Envia uma janela de mensagem tipo a do windows')
        .addStringOption(option =>
            option
            .setName('input')
            .setDescription('The message that you want to appear | A mensagem que você quer que aparecer')
            .setRequired(true)),
