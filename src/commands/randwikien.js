...
module.exports = {
    data: new SlashCommandBuilder()
	  ...
	  async execute (interaction) {
        ...
        const namespace = new MessageEmbed()
            .setColor('#97ff63')
            .setAuthor('RandWiki | Wikihow', 'https://upload.wikimedia.org/wikipedia/commons/f/fb/WikiHow_initials.png')
            .setTitle("How to Send Your Name to Space")
            ...
            .setURL('https://www.wikihow.com/Send-Your-Name-to-Space')
            .setFooter('Provided by wikihow.com')

        const bubblesnake = new MessageEmbed()
            .setColor('#97ff63')
            .setAuthor('RandWiki | Wikihow', 'https://upload.wikimedia.org/wikipedia/commons/f/fb/WikiHow_initials.png')
            .setTitle("How to Make a Bubble Snake Maker")
            ...
            .setURL('https://www.wikihow.com/Make-a-Bubble-Snake-Maker')
            .setFooter('Provided by wikihow.com')
        
        const clematispot = new MessageEmbed()
            .setColor('#97ff63')
            .setAuthor('RandWiki | Wikihow', 'https://upload.wikimedia.org/wikipedia/commons/f/fb/WikiHow_initials.png')
            .setTitle("How to Grow Clematis in Pots")
            ...
            .setURL('https://www.wikihow.com/Grow-Clematis-in-Pots')
            .setFooter('Provided by wikihow.com')
        
        const llcmissouri = new MessageEmbed()
            .setColor('#97ff63')
            .setAuthor('RandWiki | Wikihow', 'https://upload.wikimedia.org/wikipedia/commons/f/fb/WikiHow_initials.png')
            .setTitle("How to Form an LLC in Missouri")
            .setDescription("Summary:\n\nA limited liability company (LLC) is a way of setting up a corporation that offers owners some protection against debts and suits. Many individuals and groups that found businesses choose to form an LLC in order to ensure that their personal assets are protected. You can form an LLC in Missouri according to state statute 347-047. The process is based on submitting a form called the Articles of Organization to the Secretary of State.")
            .setURL('https://www.wikihow.com/Form-an-LLC-in-Missouri')
            .setFooter('Provided by wikihow.com')
    
        const subpanel = new MessageEmbed()
            .setColor('#97ff63')
            .setAuthor('RandWiki | Wikihow', 'https://upload.wikimedia.org/wikipedia/commons/f/fb/WikiHow_initials.png')
            .setTitle("How to Add a Subpanel")
            .setDescription("Summary:\n\nIf you’re trying to power an additional room or you just need more circuits, adding an electrical subpanel is a simple way to extend your circuitry, which can power additional rooms and devices. Choose the right subpanel and location for your needs. Shut off the power to the main system and connect the subpanel to your main panel using a feeder cable and breaker. Installing a subpanel can be dangerous if you’re not sure what you’re doing. If you feel uncomfortable or unsure, contact a licensed electrician to install your subpanel.")
            .setURL('https://www.wikihow.com/Add-a-Subpanel')
            .setFooter('Provided by wikihow.com')
        
        const waxhands = new MessageEmbed()
            .setColor('#97ff63')
            .setAuthor('RandWiki | Wikihow', 'https://upload.wikimedia.org/wikipedia/commons/f/fb/WikiHow_initials.png')
            .setTitle("How to Make Wax Hands")
            .setDescription("Summary:\n\nMaking wax hands requires only a few items, cheaply available at hobby stores and hardware stores. You can make a quick and easy hollow wax hand, or put in a little work and make it into a candle instead. An adult should supervise this project for all stages where hot wax is involved.")
            .setURL('https://www.wikihow.com/Make-Wax-Hands')
            .setFooter('Provided by wikihow.com')
        
        const panicattack = new MessageEmbed()
            .setColor('#97ff63')
            .setAuthor('RandWiki | Wikihow', 'https://upload.wikimedia.org/wikipedia/commons/f/fb/WikiHow_initials.png')
            .setTitle("How to Identify Panic Attacks")
            .setDescription("Summary:\n\nPanic attacks aren’t life-threatening, but they can be extremely scary. If you suffer from anxiety, depression, or high-stress, you have a greater chance of experiencing a panic attack. But that doesn’t mean you’ll have one every time you feel anxious or stressed. It's hard to know when one might happen and not everyone experiences symptoms the same way. However, if you experience at least 4 tell-tale physical and mental symptoms, you can be sure it’s a panic attack.")
            .setURL('https://www.wikihow.com/Identify-Panic-Attacks')
            .setFooter('Provided by wikihow.com')
