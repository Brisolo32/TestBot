...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand
                .setName('icon')
                .setDescription('Shows the icon of a player')
                .addStringOption(option => option.setName('playername').setDescription('The player name or id').setRequired(true))
                .addStringOption(option => option
                    .setName('type')
                    .setDescription('The type of icon')
                    .addChoice('Cube', 'cube')
                    .addChoice('Ship', 'ship')
                    .addChoice('Ball', 'ball')
                    .addChoice('UFO', 'ufo')
                    .addChoice('Wave', 'wave')
                    .addChoice('Robot', 'robot')
                    .addChoice('Spider', 'spider')
                    .addChoice('Swing', 'swing')
                    .addChoice('Cursed', 'cursed')
                    .setRequired(true))
            ),
